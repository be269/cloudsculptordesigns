...
interface CompositeGorillaSceneProps {
  bodyUrl: string;
  headUrl: string;
  gorillaColor: string;
  gorillaColor2?: string;
  gorillaColor3?: string;
  isRotating: boolean;
  scale: number;
  isMetallic: boolean;
}

function CompositeGorillaScene({
  bodyUrl,
  headUrl,
  gorillaColor,
  gorillaColor2,
  ...
  return (
    <group ref={groupRef} scale={[scale, scale, scale]}>
      ...
      <Model
        url={bodyUrl}
        color={gorillaColor}
        color2={gorillaColor2}
        color3={gorillaColor3}
...
interface STLViewerCompositeGorillaProps {
  className?: string;
  colorIndex: number;
  sizeIndex: number;
...
export default function STLViewerCompositeGorilla({
  className = "",
  colorIndex,
  sizeIndex,
  onColorChange
}: STLViewerCompositeGorillaProps) {
